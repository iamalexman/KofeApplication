...
//                    }
                    Button(action: {
                        ...
                        Text("СИРОП")
                            ...
                            .overlay(syrupDetect ? RoundedRectangle(cornerRadius: 10)
                    ...
                    Button(action: {
                        ...
                        Text("МАРШМЕЛЛОУ")
                            ...
                            .overlay(marshmellowDetect ? RoundedRectangle(cornerRadius: 10)
                                        .stroke(Color.white, lineWidth: 2) : RoundedRectangle(cornerRadius: 5)
                                        .stroke(Color.white, lineWidth: 2))
                    ...
                    Button(action: {
                        ...
                        Text("СЛИВКИ")
                            ...
                            .frame(width: 80, height: 30)
                            .overlay(creamDetect ? RoundedRectangle(cornerRadius: 10)
                                        .stroke(Color.white, lineWidth: 2) : RoundedRectangle(cornerRadius: 5)
                                        .stroke(Color.white, lineWidth: 2))
            ...
            HStack {
                ...
                HStack {
                    Button(action: {
                        ...
                        Text("S")
                            .font(.headline)
                            .foregroundColor(sDetect == true ? .white : .black)
                            .frame(width: 50, height: 50)
                            .overlay(sDetect ? RoundedRectangle(cornerRadius: 10)
                                        .stroke(Color.white, lineWidth: 2) : RoundedRectangle(cornerRadius: 10)
                                        .stroke(Color.black, lineWidth: 2))
                            .background(sDetect ? .black : .gray.opacity(0))
                            .cornerRadius(10.0)
                    }
                    Button(action: {
                        self.mDetect.toggle()
                        ...
                        Text("M")
                            .font(.headline)
                            .foregroundColor(mDetect == true ? .white : .black)
                            .frame(width: 50, height: 50)
                            .overlay(mDetect ? RoundedRectangle(cornerRadius: 10)
                                        .stroke(Color.white, lineWidth: 2) : RoundedRectangle(cornerRadius: 10)
                                        .stroke(Color.black, lineWidth: 2))
                            .background(mDetect ? .black : .gray.opacity(0))
                            .cornerRadius(10.0)
                    }
                    .cornerRadius(10.0)
                    Button(action: {
                        ...
                        Text("L")
                            .font(.headline)
                            .foregroundColor(lDetect == true ? .white : .black)
                            .frame(width: 50, height: 50)
                            .overlay(lDetect ? RoundedRectangle(cornerRadius: 10)
                                        .stroke(Color.white, lineWidth: 2) : RoundedRectangle(cornerRadius: 10)
                                        .stroke(Color.black, lineWidth: 2))
                            .background(lDetect ? .black : .gray.opacity(0))
                            .cornerRadius(10.0)
                    }
                }
            }
